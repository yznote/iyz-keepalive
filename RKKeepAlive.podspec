...
Pod::Spec.new do |s|
  s.name             = 'RKKeepAlive'
  s.version          = '0.1.0'
  s.summary          = 'A short description of RKKeepAlive.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/yuan/RKKeepAlive'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'yuan' => 'yzyuan920@163.com' }
  s.source           = { :git => 'https://github.com/yuan/RKKeepAlive.git', :tag => s.version.to_s }
